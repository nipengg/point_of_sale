...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="{{ url('/') }}"><img src="{{asset('admin/assets/img/logo-dark.png')}}" alt="Klorofil Logo" class="img-responsive logo"></a>
			</div>
			<div class="container-fluid">
				...
				<div class="navbar-btn navbar-btn-right">
					<a class="btn btn-success update-pro" href="{{url('create/book')}}" title="Upgrade to Pro"><i class="fa fa-rocket"></i> <span>Add Book</span></a>
				</div>
				<div id="navbar-menu">
